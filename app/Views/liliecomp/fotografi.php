...
<div class="px-4 py-2 w-full lg:w-6/12">
    <h5 class="text-base text-center font-black">FORM PENDAFTARAN LILIECOMP FOTOGRAFI</h5>
</div>

<div class="rounded-sm shadow p-4 bg-white w-full mt-2 text-lilie-primary lg:w-6/12">
    <form action="/liliecomp/fotografi/daftar" method="post" enctype="multipart/form-data">
        ...
        <input value="<?= old('instansi'); ?>" class="w-full rounded-sm border border-lilie-primary p-1 focus:outline-none" type="text" name="instansi" id="instansi">
