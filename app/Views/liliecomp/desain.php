...
<div class="px-4 py-2 w-full lg:w-6/12">
    <h5 class="text-base text-center font-black">FORM PENDAFTARAN LILIECOMP DESAIN GRAFIS</h5>
</div>
...
<div class="rounded-sm shadow p-4 bg-white w-full mt-2 text-lilie-primary lg:w-6/12">
    <form action="/liliecomp/desain/daftar" method="post" enctype="multipart/form-data">
        ...
        <small class="text-red-500"><?= isset($errors['identitas']) ? $errors['identitas'] : ""; ?></small><br>
