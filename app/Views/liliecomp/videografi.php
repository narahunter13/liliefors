...
<?php if ($terdaftar < 1) { ?>
    ...
    <div class="rounded-sm shadow-lg p-4 bg-white w-full mt-4 lg:w-6/12">
        <form action="/liliecomp/videografi/daftar" method="post" enctype="multipart/form-data">
            ...
            <input value="<?= old('nama_lengkap_2') ?>" class="mb-8 w-full rounded-none border border-black p-1 focus:outline-none" type="text" name="nama_lengkap_2" id="nama_lengkap_2">
            <label for="email_2">Email</label><br>
            <input value="<?= old('email_2') ?>" class="mb-8 w-full rounded-none border border-black p-1 focus:outline-none" type="email" name="email_2" id="email_2">
            <label for="asal_daerah_2">Asal Daerah (Kabupaten/Kota, Provinsi)</label><br>
            <input value="<?= old('asal_daerah'); ?>" class="w-full rounded-none border border-black p-1 focus:outline-none" type="text" name="asal_daerah_2" id="asal_daerah_2">
            <p class="mb-8 text-sm font-thin my-1">Contoh: Palembang, Sumatera Selatan</p>
            <label for="nomor_wa_2">No. WA yang Aktif</label><br>
            <input value="<?= old('nomor_wa'); ?>" class="mb-8 w-full rounded-none border border-black p-1 focus:outline-none" type="text" name="nomor_wa_2" id="nomor_wa_2">
            <label for="sosial_media_2">Sosial Media</label><br>
            <input value="<?= old('sosial_media'); ?>" class="w-full rounded-none border border-black p-1 focus:outline-none" type="text" name="sosial_media_2" id="sosial_media_2">
            <p class="mb-8 text-sm font-thin my-1 text-justify">Contoh: Instagram:@abcxyz</p>
            ...
            <input value="<?= old('nama_lengkap_3') ?>" class="mb-8 w-full rounded-none border border-black p-1 focus:outline-none" type="text" name="nama_lengkap_3" id="nama_lengkap_3">
            <label for="email_3">Email</label><br>
            <input value="<?= old('email_3') ?>" class="mb-8 w-full rounded-none border border-black p-1 focus:outline-none" type="email" name="email_3" id="email_3">
            <label for="asal_daerah_3">Asal Daerah (Kabupaten/Kota, Provinsi)</label><br>
            <input value="<?= old('asal_daerah'); ?>" class="w-full rounded-none border border-black p-1 focus:outline-none" type="text" name="asal_daerah_3" id="asal_daerah_3">
            <p class="mb-8 text-sm font-thin my-1">Contoh: Palembang, Sumatera Selatan</p>
            <label for="nomor_wa_3">No. WA yang Aktif</label><br>
            <input value="<?= old('nomor_wa'); ?>" class="mb-8 w-full rounded-none border border-black p-1 focus:outline-none" type="text" name="nomor_wa_3" id="nomor_wa_3">
            <label for="sosial_media_3">Sosial Media</label><br>
            <input value="<?= old('sosial_media'); ?>" class="w-full rounded-none border border-black p-1 focus:outline-none" type="text" name="sosial_media_3" id="sosial_media_3">
            <p class="mb-8 text-sm font-thin my-1 text-justify">Contoh: Instagram:@abcxyz</p>
            ...
            <input value="<?= old('instansi'); ?>" class="w-full rounded-none border border-black p-1 focus:outline-none mb-4" type="text" name="instansi" id="instansi">
            <br>
            <label for="identitas">Tanda Pengenal</label>
