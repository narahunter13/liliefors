...
<body class="min-h-screen bg-lilie-bg font-lilie">
    <nav class="text-lg p-4 flex justify-between sm:p-8">
        ...
        <div class="flex">
            <a href="/masuk" class="bg-lilie-warning shadow text-lilie-primary rounded-sm p-1 px-4 font-bold text-sm flex items-center">
    ...
    <section class="flex flex-col items-center p-4 font-lilie text-lilie-primary">
        <?php if ($terdaftar < 1) { ?>
            <?= $this->renderSection('content'); ?>
        <?php } else { ?>
            <div class="flex flex-col text-lilie-primary justify-center items-center w-full px-4 md:w-6/12">
                <?php if ($terbayar['status_pembayaran'] == 1) { ?>
                    <div class="justify-self-center self-center">
                        <div class="text-lilie-bg bg-lilie-primary p-2 text-center">SELAMAT! Anda telah mendaftar. Silahkan menuju <a href="<?= base_url('user/pengumuman'); ?>" class="underline">dashboard</a></div>
                        <div class="mt-8 text-base text-center">*Catatan: Apabila terdapat kesalahan dalam pengisian data diri, silahkan melapor ke panitia melalui:</div>
                        <div class="text-base text-center">Farah : 0853-3529-8757</div>
                    </div>
                <?php } else { ?>
                    <div class="bg-lilie-warning text-justify p-2 font-italic text-lilie-primary mt-12 md:mt-4">SELAMAT! Anda telah mendaftar. Silahkan melakukan pembayaran sebesar <br><b class="text-center">Rp. <?= $terbayar['jumlah_dibayar'] ?></b> ke salah satu media pembayaran berikut:</div>
                    <ul class="text-lilie-primary list-disc mt-4 text-justify leading-relaxed">
                    ...
                    <div class="bg-lilie-primary text-justify p-2 font-italic text-lilie-bg mt-4">Setelah itu dimohon untuk melakukan konfirmasi pembayaran pada salah satu kontak di bawah:</div>
                    <ul class="text-lilie-primary mt-2 list-disc">
                    ...
                    <div class="mt-8 text-base text-center text-lilie-primary">*Catatan: Apabila terdapat kesalahan dalam pengisian data diri, silahkan melapor ke panitia melalui:</div>
                    <div class="text-base text-center text-lilie-primary">Farah : 0853-3529-8757</div>
                    <a href="<?= base_url(); ?>" class="font-italic text-lilie-primary mt-8 underline">Kembali ke beranda</a>
                <?php } ?>
            </div>
        <?php } ?>
    </section>
