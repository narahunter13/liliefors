...
<head>
    ...
    <title>Registrasi | Liliefors 2021</title>
</head>

<body class="min-h-screen p-4 flex flex-col justify-center items-center bg-lilie-bg font-lilie overflow-auto">
    <div class="w-full mb-8">
        <div class="rounded-sm bg-white shadow text-sm p-4 w-full text-lilie-primary sm:w-3/4 md:w-2/4 lg:w-2/6 sm:mx-auto">
            <svg class="w-2/4 h-auto mx-auto" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150.71 173.53">
                <defs>
                    <style>
                        .cls-1 {
                            fill: #d24635;
            ...
            <form action="/registrasi/create" method="post" autocomplete="off">
                ...
                <input value="<?= old('email'); ?>" class="border border-lilie-primary rounded-sm w-full px-2 py-1" autocomplete="false" type="email" name="email" id="email">
                <small class="text-red-500"><?= get_error($errors, 'email'); ?></small>
                <h5 class="mt-4 mb-2">Nama Lengkap</h5>
                <input value="<?= old('nama'); ?>" class="border border-lilie-primary rounded-sm w-full px-2 py-1" autocomplete="false" type="text" name="nama" id="nama">
                <small class="text-red-500"><?= get_error($errors, 'nama'); ?></small>
                <h5 class="mt-4 mb-2">Kata Sandi</h5>
                <input value="<?= old('password'); ?>" class="border border-lilie-primary rounded-sm w-full px-2 py-1" type="password" name="password" id="password">
                <small class="text-red-500"><?= get_error($errors, 'password'); ?></small>
                <h5 class="mt-4 mb-2">Konfirmasi Kata Sandi</h5>
                <input value="<?= old('konfirmasi_password'); ?>" class="border border-lilie-primary rounded-sm w-full px-2 py-1" type="password" name="konfirmasi_password" id="konfirmasi_password">
                <small class="text-red-500"><?= get_error($errors, 'konfirmasi'); ?></small>
                <button class="bg-lilie-warning shadow w-full text-lilie-primary rounded-sm p-2 px-4 font-bold text-sm flex items-center justify-center mt-4" id="submit" type="submit">Registrasi</button>
            </form>
        </div>
    </div>
