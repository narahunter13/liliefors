...
<head>
    ...
    <title>Masuk | Liliefors 2021</title>
</head>

<body class="min-h-screen p-4 flex flex-col justify-center items-center bg-lilie-bg font-lilie overflow-auto">
    <div class="w-full mb-8 sm:w-3/4 md:w-2/4 lg:w-2/6">
        <?= isset($success) ? "<div class='alert w-full bg-lilie-primary relative px-4 py-2 mb-4 rounded-sm'>
        ...
        <div class="rounded-sm bg-white shadow text-sm p-4 w-full text-lilie-primary sm:mx-auto">
            ...
            <form action="/masuk/auth" method="post" autocomplete="off">
                ...
                <input class="border border-lilie-primary rounded-sm w-full px-2 py-1" autocomplete="false" type="email" name="email" id="email">
                <h5 class="mt-4 mb-2">Kata Sandi</h5>
                <input class="border border-lilie-primary rounded-sm w-full px-2 py-1" type="password" name="password" id="password">
                <button class="bg-lilie-warning shadow w-full text-lilie-primary rounded-sm p-2 px-4 font-bold text-sm flex items-center justify-center mt-4" id="submit" type="submit">Masuk</button>
            </form>
            <h5 class="mt-4 mb-4 text-center">atau</h5>
            <a href="/registrasi" class="bg-lilie-primary shadow w-full text-lilie-bg rounded-sm p-2 px-4 font-bold text-sm flex items-center justify-center" id="reg" type="button">Registrasi</a>
        </div>
    </div>
