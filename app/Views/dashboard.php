...
<body class="m-0 p-0">
    ...
    <div id="burger-navigation" class="h-screen nav-mobile w-8/12 absolute top-0 z-50 text-center lg:hidden">
        ...
        <div class="flex divide-y divide-white divide-opacity-40 flex-col border-white border-opacity-40 border-b border-t">
            <a class="text-white text-base font-normal w-full py-4" href="#">PENGUMUMAN</a>
            <a class="text-white text-base font-normal w-full py-4" href="#">SUNTING PROFIL</a>
            <a class="text-white text-base font-normal w-full py-4" href="#">DAFTAR LILIECOMP</a>
            <a class="text-white text-base font-normal w-full py-4" href="#">KELUAR</a>
        </div>
    </div>

    <nav id="navbar" class="hidden lg:flex w-full flex-row justify-end py-2 px-6 sticky top-0 z-50">
        <div class="flex flex-row justify-center">
            <h5 class="title text-lg text-white text-center flex flex-col justify-center">L I L I E F O R S</h5>
            <div class="border border-white mx-2 h-2/3 my-auto"></div>
            <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="64px" height="64px" version="1.1" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd" viewBox="0 0 9144 9144" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xodm="http://www.corel.com/coreldraw/odm/2003">
