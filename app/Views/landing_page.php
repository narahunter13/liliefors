...
<section id="title" class="flex flex-col justify-center items-center p-10 md:p-20 text-white">
    ...
    <h5 class="font-light text-base md:text-xl text-center italic">"Be Confident and Impact Others"</h5>
    ...
    <div class="mt-12 flex flex-col items-center md:flex-row md:justify-between md:px-20">
        ...
        <div class="flex flex-col justify-center md:ml-8">
            <h4 class="text-base font-regular text-white">PENULISAN</h5>
                ...
                <p class="mt-4 text-white text-justify font-normal">Nama manusia dapat abadi dan dikenang melalui karya, tak terkecuali karya tulis. Cerpen hanyalah satu di antara beragam bentuk karya tulis. Cerpen menjadi media untuk meninggalkan tanda melalui cerita fantasi maupun pasti. Bertemakan "Break My Fear, Build My Confidence", ciptakan cerpen yang menarik dan menginspirasi.</p>
        </div>
    </div>
...
<section class="px-4 py-10" id="klinik">
    ...
    <div class="flex flex-col divide-y divide-white text-white md:divide-none">
        <div class="my-8 flex flex-col items-center md:flex-row md:justify-between md:px-20">
            <div class="flex flex-col py-4 md:p-0 md:mr-8">
                <embed class="h-60 w-auto my-4" src="/assets/img/pembicara-1.svg">
                <h4 class="text-base font-normal text-center -mt-16">ALVI SYAHRIN</h4>
            </div>
            <div>
        ...
        <div class="my-8 flex flex-col items-center md:flex-row md:justify-between md:px-20 md:flex-row-reverse">
            <div class="flex flex-col py-4 md:p-0 md:ml-8">
                <embed class="h-60 w-auto my-4" src="/assets/img/pembicara-2.svg">
                <h4 class="text-base font-normal text-center -mt-16">INGGA SUWANDANA</h4>
            </div>
            <div>
        ...
        <div class="my-8 flex flex-col items-center md:flex-row md:justify-between md:px-20">
            <div class="flex flex-col py-4 md:p-0 md:mr-8">
                <embed class="h-60 w-auto my-4" src="/assets/img/pembicara-3.svg">
                <h4 class="text-base font-normal text-center -mt-16">ENRICO JONATHAN</h4>
            </div>
            <div>
        ...
        <div class="my-8 flex flex-col items-center md:flex-row md:justify-between md:px-20 md:flex-row-reverse">
            <div class="flex flex-col py-4 md:p-0 md:ml-8">
                <embed class="h-60 w-auto my-4" src="/assets/img/pembicara-4.svg">
                <h4 class="text-base font-normal text-center -mt-16">NAZHIF UBAIDILLAH</h4>
            </div>
            <div>
...
<script>
    ...
    var burger_nav_landing = document.getElementById('burger-navigation-landing');
    burger_landing.addEventListener('click', () => {
        burger_nav_landing.style.transform = 'translateX(0)';
        burger_background_landing.style.opacity = 0.2;
        burger_background_landing.style.display = 'block';
    });
    burger_background_landing.addEventListener('click', () => {
        burger_nav_landing.style.transform = 'translateX(-100%)';
        burger_background_landing.style.opacity = 0;
        burger_background_landing.style.display = 'none';
    });
</script>
<?= $this->endSection() ?>