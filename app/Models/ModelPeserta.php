...
class ModelPeserta extends Model
{
	...
	{
		$sql = "SELECT u.nama, u.email, l.id, l.lomba, l.jumlah_dibayar, l.kode_referal, l.status_pembayaran FROM users as u JOIN peserta_lomba as l ON u.id = l.id_peserta";
